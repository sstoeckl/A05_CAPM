...
author: "Kontostavlos-P., Christina"
...
@@ -22,6 +25,256 @@ a) Minimum-Variance
...
colnames(R) <- c("CBL", "CCL", "CEA", "CLB", "CNX", "COG", "CPT", "CRT", "KOF", "KFY")
funds <- colnames(R)
```
...
@@ -33,6 +286,515 @@ c) Now subtract the risk-free rate from all the stocks. Then estimate each stock
...
@@ -43,3 +805,257 @@ a)	Subtract the risk-free rate from the first set of 10 portfolios (only sorted
